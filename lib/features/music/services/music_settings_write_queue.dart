...
typedef MusicSettingWrite = Future<void> Function(String key, String value);

class MusicSettingsWriteQueue {
  MusicSettingsWriteQueue({
    required MusicSettingWrite write,
    Duration writeDelay = const Duration(milliseconds: 350),
  }) : _write = write,
       _writeDelay = writeDelay;

  final MusicSettingWrite _write;
