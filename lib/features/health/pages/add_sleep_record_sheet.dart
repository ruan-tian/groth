            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // ── 时间选择 ──
                  _buildTimeField(
                      '上床时间', _bedTime, (t) => setState(() => _bedTime = t)),
                  const SizedBox(height: AppSpacing.md),
                  _buildTimeField(
                      '入睡时间', _sleepTime, (t) => setState(() => _sleepTime = t)),
                  const SizedBox(height: AppSpacing.md),
                  _buildTimeField(
                      '起床时间', _wakeTime, (t) => setState(() => _wakeTime = t)),
                  const SizedBox(height: AppSpacing.lg),
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.calculate, color: AppColors.sleep),
                  ...
                  // ── 入睡耗时 ──
                  Text('入睡耗时: $_fallAsleepMinutes 分钟',
                      style: AppTextStyles.cardTitle),
                  const SizedBox(height: AppSpacing.sm),
                  Slider(
  ...
  Widget _buildDateField() {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Icon(Icons.calendar_today, color: AppColors.sleep),
  ...
  Widget _buildTimeField(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Icon(Icons.access_time, color: AppColors.sleep),
            const SizedBox(width: AppSpacing.md),
  ...
  Future<void> _save() async {
    ...
    await repo.insertSleepRecord(
      SleepRecordsCompanion(
        ...
        dreamNote: Value(_dreamController.text.trim().isEmpty
            ? null
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: selected
              ? AppColors.sleep.withValues(alpha: 0.1)
              : AppColors.card,
          borderRadius: BorderRadius.circular(AppRadius.xxl),
          border: Border.all(
            color: selected ? AppColors.sleep : AppColors.border,
          ),
        ),
        child: Text(
          label,
