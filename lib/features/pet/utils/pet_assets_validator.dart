...
class PetAssetsValidator {
  ...
  static const _allPaths = <String>[
    // Module scene states
    PetAssets.studyReading,
    PetAssets.studyWriting,
    PetAssets.studyFocus,
    PetAssets.studyDone,
    PetAssets.fitnessLifting,
    PetAssets.fitnessStretch,
    PetAssets.fitnessDrink,
    PetAssets.fitnessDone,
    PetAssets.journalWriting,
    PetAssets.journalThinking,
    PetAssets.journalBook,
    PetAssets.journalDone,
    PetAssets.dietEating,
    PetAssets.dietDrink,
    PetAssets.dietPlate,
    PetAssets.dietDone,
    PetAssets.sleepYawn,
    PetAssets.sleepSleeping,
    PetAssets.sleepStretch,
    PetAssets.sleepDone,
    // Module defaults
    PetAssets.moduleDefaultStudy,
    PetAssets.moduleDefaultFitness,
    PetAssets.moduleDefaultJournal,
    PetAssets.moduleDefaultDiet, PetAssets.moduleDefaultSleep,
    // Common
    PetAssets.commonHappy,
    PetAssets.commonIdle,
    PetAssets.commonThinking,
    PetAssets.commonReport,
    PetAssets.commonError,
    PetAssets.commonLoading,
    PetAssets.commonEmpty,
    PetAssets.commonWarning,
    ...
    PetAssets.aiReport,
    PetAssets.aiPrivacy,
    PetAssets.aiPointing,
    PetAssets.aiNetworkError,
    PetAssets.aiKeyMissing,
    PetAssets.aiJsonError,
    PetAssets.aiDailySummary,
    // Hero
    PetAssets.heroMorning,
    PetAssets.heroAfternoon,
    PetAssets.heroEvening,
    PetAssets.heroNight,
    // Root fallbacks
    PetAssets.petIdle,
    PetAssets.petHappy,
