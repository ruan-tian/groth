...
class PetEvent {
  ...
  factory PetEvent.musicStarted() {
    return PetEvent(
      eventId: 'music_started_${DateTime.now().millisecondsSinceEpoch}',
      source: PetEventSource.userAction,
      type: PetEventType.musicStarted,
      module: 'music',
    );
  }
  ...
  factory PetEvent.accountingStarted() {
    return PetEvent(
      eventId: 'accounting_started_${DateTime.now().millisecondsSinceEpoch}',
      source: PetEventSource.userAction,
      type: PetEventType.accountingStarted,
      module: 'accounting',
    );
  }
