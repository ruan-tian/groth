...
import 'knowledge_v3_schema.dart';
...
class AppDatabase extends _$AppDatabase {
  ...
  Future<void> _createKnowledgeV3Tables() {
    return KnowledgeV3SchemaService.createTables(this);
  }

  Future<void> _ensureKnowledgeV3Schema() {
    return KnowledgeV3SchemaService.ensureCardColumns(this);
  }
