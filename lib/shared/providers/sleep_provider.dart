...
/// 指定日期的睡眠记录
final sleepRecordByDateProvider =
    FutureProvider.family<SleepRecord?, DateTime>((ref, date) async {
...
/// 最近7天每日睡眠时长
final weeklySleepDurationProvider =
...
/// 最近30天每日睡眠时长
final monthlySleepDurationProvider =
    FutureProvider<List<Map<String, dynamic>>>((ref) async {
  final repo = ref.watch(sleepRepositoryProvider);
...
/// 最近7天每日睡眠质量
final weeklySleepQualityProvider =
    FutureProvider<List<Map<String, dynamic>>>((ref) async {
  final repo = ref.watch(sleepRepositoryProvider);
...
/// 最近30天每日睡眠质量
final monthlySleepQualityProvider =
    FutureProvider<List<Map<String, dynamic>>>((ref) async {
  final repo = ref.watch(sleepRepositoryProvider);
...
/// 最近365天每日睡眠时长
final yearlySleepDurationProvider =
    FutureProvider<List<Map<String, dynamic>>>((ref) async {
  final repo = ref.watch(sleepRepositoryProvider);
...
/// 最近365天每日睡眠质量
final yearlySleepQualityProvider =
    FutureProvider<List<Map<String, dynamic>>>((ref) async {
  final repo = ref.watch(sleepRepositoryProvider);
...
final sleepRecordByIdProvider =
    FutureProvider.family<SleepRecord?, int>((ref, id) async {
  final repo = ref.watch(sleepRepositoryProvider);
